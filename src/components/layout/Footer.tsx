...
const Footer: React.FC = () => {
  return (
    <footer className="bg-light-teal py-12 mt-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand Column */}
          <div className="col-span-1">            
            <Link to="/" className="text-2xl font-semibold text-dark-teal mb-4 block">
              ArtisanCraft
            </Link>
            ...
            <div className="flex space-x-4">
              <a 
                href="#" 
                className="text-gray-600 hover:text-dark-teal transition-colors"
                aria-label="Facebook"
              >
                <Facebook size={20} />
              </a>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">              
              <li>
                <Link to="/products" className="text-gray-600 hover:text-dark-teal transition-colors">
                  All Products
                </Link>
              </li>
              <li>
                <Link to="/products?category=ceramics" className="text-gray-600 hover:text-dark-teal transition-colors">
                  Ceramics
                </Link>
              </li>
              <li>
                <Link to="/products?category=textiles" className="text-gray-600 hover:text-dark-teal transition-colors">
                  Textiles
                </Link>
              </li>
              <li>
                <Link to="/products?category=jewelry" className="text-gray-600 hover:text-dark-teal transition-colors">
                  Jewelry
                </Link>
              </li>              
              <li>
        ...
        <div className="border-t border-gray-200 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <Link to="/privacy" className="text-gray-600 hover:text-dark-teal text-sm transition-colors">
              Privacy Policy
            </Link>            
